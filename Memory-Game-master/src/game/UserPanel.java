...
public class UserPanel extends JPanel {
    ...
    public void addAttemptsLabel() {
        ...
        attemptsLabel.setFont(new Font("Arial", Font.BOLD, 50));
        attemptsLabel.setText("Attempts: 000");
        attemptsLabel.setBorder(new EmptyBorder(0, 120, 100, 0));
    ...
    public void addButton(JButton button, String iconName, ActionListener listener) {
        ...
        button.setBorder(new EmptyBorder(0, 0, 15, 0));
    ...
    public void setTimerStopped() {
        timeLabel.setText("Timer Stopped");
        timeLabel.setForeground(Color.RED); // Ubah warna untuk menunjukkan status berhenti
    }    
